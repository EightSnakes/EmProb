...
public class menu2Problemas extends javax.swing.JFrame {
    ...
    private void consultarbotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarbotonActionPerformed
        ...
        if (tc.consulta() == 0){
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultarProblemas().setVisible(true);
            }
        });
            this.dispose();
        } else {
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new ConGenProblemas().setVisible(true);
                }
            });
            this.dispose();
        }
    ...
    private void eliminarbotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarbotonActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new eliminarProblemas().setVisible(true);
            }
        });
            this.dispose();
    ...
    private void modificarbotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarbotonActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificarProblemas().setVisible(true);
            }
        });
            this.dispose();
