...
public class ConGenTiendas extends javax.swing.JFrame {
     ...
     */
    public ConGenTiendas() {
        initComponents();
        this.setLocationRelativeTo(null);
        try {
            Statement sql = Conexion.getConexion().createStatement();
            ResultSet rs;
            rs = sql.executeQuery("SELECT * FROM Tiendas");
            DefaultTableModel tm = (DefaultTableModel)jTable1.getModel();
            tm.setRowCount(0);
            
            while(rs.next()){
                Object obj[] = {rs.getInt("ID_Tienda"), rs.getInt("ID_Encargado"), rs.getString("Telefono_T"), rs.getString("Calle"), 
                    rs.getInt("Numero_Calle"), rs.getString("Colonia"), rs.getString("Municipio"), rs.getString("Estado")};
                tm.addRow(obj);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_Tienda", "ID_Encargado", "Telefono_T", "Calle", "Numero_Calle", "Colonia", "Municipio", "Estado"
            }
        ) {
