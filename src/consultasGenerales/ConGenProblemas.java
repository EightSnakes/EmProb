...
public class ConGenProblemas extends javax.swing.JFrame {
     ...
     */
    public ConGenProblemas() {
        initComponents();
        this.setLocationRelativeTo(null);
        try {
            Statement sql = Conexion.getConexion().createStatement();
            ResultSet rs;
            rs = sql.executeQuery("SELECT * FROM Problema");
            DefaultTableModel tm = (DefaultTableModel)jTable1.getModel();
            tm.setRowCount(0);
            
            while(rs.next()){
                Object obj[] = {rs.getInt("ID_Problema"), rs.getString("Nombre_P"), rs.getString("Descripcion"), rs.getString("Solucion_Sugerida")};
                tm.addRow(obj);
            }
